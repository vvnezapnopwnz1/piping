...
const inspectionPassRateData = [{ name: "Pass Rate", value: 94, fill: "#10b981" }]
...
const weeklySummaryData = [
  ...
  { metric: "Inspection Pass Rate", w4: "92%", w5: "93%", w6: "94%", trend: "up" },
  { metric: "Rework Items", w4: 22, w5: 14, w6: 10, trend: "down" },
  { metric: "Material Utilization", w4: "87%", w5: "89%", w6: "91%", trend: "up" },
]
...
const riskHeatmapData = [
  { area: "Schedule", wbu1: "low", wbu2: "medium", wbu3: "low", wbu4: "high", wbu5: "medium" },
  { area: "Quality", wbu1: "low", wbu2: "low", wbu3: "medium", wbu4: "low", wbu5: "low" },
  { area: "Resource", wbu1: "medium", wbu2: "low", wbu3: "high", wbu4: "medium", wbu5: "low" },
  { area: "Material", wbu1: "high", wbu2: "medium", wbu3: "low", wbu4: "medium", wbu5: "high" },
] as const

const materialShortages = [
  { material: '6" CS Pipe Sch 40', required: 450, available: 120, unit: "m" },
  { material: '4" SS 316L Elbow 90°', required: 85, available: 32, unit: "pcs" },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-3xl font-bold text-emerald-600">+8.3%</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">Days ahead of schedule</p>
            <div className="flex items-center gap-1 mt-1 text-sm text-emerald-600">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium">Fabrication Progress</CardTitle>
            ...
            <div className="h-[200px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={fabricationProgressData}>
                  ...
                  <Line type="monotone" dataKey="planned" stroke="#94a3b8" strokeWidth={2} strokeDasharray="5 5" dot={false} />
                  <Line type="monotone" dataKey="actual" stroke="#3b82f6" strokeWidth={2} dot={{ fill: "#3b82f6", r: 4 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium">Welding Progress</CardTitle>
            ...
            <div className="h-[200px]">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={weldingProgressData}>
                  ...
                  <Tooltip />
                  <Legend wrapperStyle={{ fontSize: 12 }} />
                  <Area type="monotone" dataKey="butt" stackId="1" stroke="#3b82f6" fill="#3b82f6" fillOpacity={0.8} />
                  <Area type="monotone" dataKey="socket" stackId="1" stroke="#10b981" fill="#10b981" fillOpacity={0.8} />
                  <Area type="monotone" dataKey="fillet" stackId="1" stroke="#f59e0b" fill="#f59e0b" fillOpacity={0.8} />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-medium">Weld Status Matrix</CardTitle>
            ...
            <div className="h-[280px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={weldStatusMatrixData} layout="vertical">
                  ...
                  <YAxis dataKey="wbu" type="category" tick={{ fontSize: 12 }} width={60} />
                  <Tooltip />
                  <Legend wrapperStyle={{ fontSize: 12 }} />
                  <Bar dataKey="complete" stackId="a" fill="#10b981" name="Complete" />
                  <Bar dataKey="inProgress" stackId="a" fill="#f59e0b" name="In Progress" />
                  <Bar dataKey="ready" stackId="a" fill="#94a3b8" name="Ready" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-medium">Weld Distribution by Area</CardTitle>
            <CardDescription>Weld count by design area and type</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-[280px]">
              <ResponsiveContainer width="100%" height="100%">
            ...
            <div className="h-[280px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={reworkTrendData}>
                  ...
                  <Tooltip />
                  <Legend wrapperStyle={{ fontSize: 12 }} />
                  <Line yAxisId="left" type="monotone" dataKey="count" stroke="#ef4444" strokeWidth={2} name="Rework Count" dot={{ fill: "#ef4444", r: 4 }} />
                  <Line yAxisId="right" type="monotone" dataKey="percentage" stroke="#f59e0b" strokeWidth={2} strokeDasharray="5 5" name="% of Total" dot={{ fill: "#f59e0b", r: 4 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
              ...
              <TableBody>
                {weeklySummaryData.map((row) => (
                  <TableRow key={row.metric}>
                    ...
                    <TableCell className="text-right font-medium">{row.w6}</TableCell>
                ...
                <tbody>
                  {riskHeatmapData.map((row) => (
                    <tr key={row.area}>
                      ...
                      <td className="p-1">
                        <div className={`w-8 h-8 mx-auto rounded ${getRiskColor(row.wbu1)}`} />
                      </td>
                      <td className="p-1">
                        <div className={`w-8 h-8 mx-auto rounded ${getRiskColor(row.wbu2)}`} />
                      </td>
                      <td className="p-1">
                        <div className={`w-8 h-8 mx-auto rounded ${getRiskColor(row.wbu3)}`} />
                      </td>
                      <td className="p-1">
                        <div className={`w-8 h-8 mx-auto rounded ${getRiskColor(row.wbu4)}`} />
                      </td>
                      <td className="p-1">
                        <div className={`w-8 h-8 mx-auto rounded ${getRiskColor(row.wbu5)}`} />
                      </td>
                    </tr>
                  ))}
                </tbody>
              ...
              return (
                <div key={index} className="space-y-2">
                  ...
                  <div className="flex items-center justify-between text-xs text-muted-foreground">
                    ...
                    <Badge variant={percentage < 50 ? "destructive" : "secondary"} className="text-xs">
                      {percentage < 30 ? "Critical" : percentage < 50 ? "Low" : "OK"}
                    </Badge>
                  </div>
                </div>
              )
