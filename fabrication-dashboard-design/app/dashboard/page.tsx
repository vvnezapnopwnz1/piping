...
export default function FabricationDashboard() {
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50/50 min-h-screen">
      ...
      <div className="sticky top-0 z-40 -mx-6 -mt-6 px-6 py-3 bg-white border-b shadow-sm">
      ...
      {/* Section 3: Progress Charts Row */}
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        {/* Fabrication Progress Line Chart */}
        <Card>
          <CardHeader className="pb-2">
        ...
        {/* Inspection Pass Rate Radial Chart */}
        <Card>
          <CardHeader className="pb-2">
      ...
      {/* Section 4: Weld Status & Distribution */}
