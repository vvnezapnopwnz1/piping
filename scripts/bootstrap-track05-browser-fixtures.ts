...
/**
 * Imports the Track 05 engineering definition as the fixture project admin. The import
 * driver itself lives in `spoolgen-fixture-import.ts`, shared with the Track 06 bootstrap.
 */
export async function seedEngineeringDefinition(
  ...
  try {
    return await importSpoolgenDefinition(
      operator,
      projectId,
      "ISO-T4-001",
      {
