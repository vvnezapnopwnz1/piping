...
| The fixture test asserted `planInsertCount === 12` where the plan's own builder returned 10                    | The plan was internally inconsistent. The count is now 13 and matches the collections the script writes.        |
